describe('Dropbox Website', () => {
    ...
    it('should have a functional login button and can access Google sign in', () => {
      ...
      cy.get('.dwg-bg-color--standard > :nth-child(4) > .dwg-nav-item-button > .dwg-text')
        .click()
    ...
    it('should allow signing in with Apple account', () => {
      ...
      it('should allow signing in with incorrect password', () => {
        ...
        cy.get('.text-input-wrapper')
          .type('random_email@example.com')
    
        // Click on the "Continue" button
        cy.get('.sso-container--dwg-refresh > .dwg-stack')
          .click()
    
        // Type an incorrect password in the "Password" field
        cy.get('.credentials-form__fields > .text-input > .text-input-wrapper')
          .type('incorrect_password')
    
        // Uncheck the "Remember me" checkbox
        cy.get('.login-submit-container--dwg-refresh > .auth__checkbox-row > .dig-FormRow input[type="checkbox"]')
          .uncheck()
    
        // Click on the "Continue" button
        cy.get('.login-submit-container--dwg-refresh > .dwg-stack')
          .click()
        ...
        it('should navigate to Dropbox website and change language to Italian', () => {
          ...
          cy.get('.dwg-text > .dwg-align-items--center > .dwg-box')
            .should('be.visible')
          ...
          cy.get(':nth-child(10) > .locale-option')
            .click()

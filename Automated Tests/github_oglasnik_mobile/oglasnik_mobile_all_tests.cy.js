describe('Oglasnik Website', () => {
    ...
    it('Try to login with wrong credentials', () => {
      ...
      cy.contains('Greška! Korisničko ime i/ili lozinka nisu ispravni')
        .should('be.visible');
    }); 
    ...
    it('Try to sign-up with wrong credentials', () => {
      ...
      cy.url().should('include', 'https://www.oglasnik.hr/user/signup')
        ...
        cy.contains('Registracija fizičke osobe')
          .should('be.visible')
      ...
      it('Should find a specific car', () => {
        ...
        cy.get('.section-auto-moto-nautika > .section-box > a > .bg-box > .background')
          .click()
        ...
        cy.get(':nth-child(1) > .section-box > a > .bg-box > .background')
          .click()
        ...
        cy.get('#filters-anchor > div.filters-main-buttons > button.btn.btn-primary.width-full.text-bold.margin-bottom-10px')
          .should('be.visible')
          .contains('Pretraži')
      
        // Choose 'Mercedes-Benz' from drop-down menu in 'Marka' filter
        cy.get('#parameter_7_level_1_box > .bootstrap-select > .dropdown-toggle > .filter-option')
          .click()
        cy.contains('Mercedes-Benz')
          .click()
      
        // Click on 'Potvrdi odabir'
        cy.get('#parameter_7_level_1_box > .bootstrap-select > .open > .bs-actionsbox > .btn-group > .bs-confirm-selection')
          .click()
      
        // Choose 'C-klasa' from drop-down menu in 'Model' filter
        cy.get('#parameter_7_level_2_box > .bootstrap-select > .dropdown-toggle > .filter-option')
          .click()
        cy.contains('C-klasa')
          .click()
      
        // Click on 'Potvrdi odabir'
        cy.get('#parameter_7_level_2_box > .bootstrap-select > .open > .bs-actionsbox > .btn-group > .bs-confirm-selection')
          .click()
      
        // Click on 'Pretraži'
        cy.get('.filters-main-buttons > [type="submit"]')
          .click()
      ...
      it('Should find specific mobile phones and sort the results', () => {
        ...
        cy.get('#page-mm-container > div.container.no-padding-xs > div > h1')
        ...
        cy.url().should('include', 'https://www.oglasnik.hr/apple-iphone?sort=expensive')
      })
      ...
      it('Should find specific pet fish', () => {
        ...
        cy.get('#filterBitsContainer > div > div.col-md-6.filterBits')
          .should('contain', 'Pojam: Pterophyllum Scalare')
        ...
        cy.get('#filterBitsContainer > div > div.col-md-6.filterBits')
          .should('not.contain', 'Pojam: Pterophyllum Scalare');
      })
